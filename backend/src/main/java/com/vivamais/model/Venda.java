...
@Table(name = "vendas", indexes = {
    @Index(name = "idx_venda_data_status", columnList = "dataHora, status"),
    @Index(name = "idx_venda_numero", columnList = "numeroVenda")
})
public class Venda {
    ...
    private String status = "CONCLUIDA"; // CONCLUIDA, CANCELADA
